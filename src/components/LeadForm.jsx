...
<div className="flex items-start gap-3 mt-4 mb-4">
  ...
  >
    Optional: I agree to receive SMS messages from DVS Automation Solutions LLC
    regarding my inquiry, requested services, appointment scheduling, customer
    support, and service updates. Message frequency varies. Message and data
    rates may apply. Reply STOP to opt out and HELP for assistance. Consent is
